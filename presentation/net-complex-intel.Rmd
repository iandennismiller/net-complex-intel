...
![Cumulative views over time](assets/memelab/cumulative-views.png)

## {.side-image .bigger}

![Total hits received per meme](assets/memelab/total-hits.png)

## {.side-image .bigger}

![Model of intention to share](assets/memelab/intention-to-share.png)
...
![Simulation result time series](assets/memelab/simulation-result.png)
